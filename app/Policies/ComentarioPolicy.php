...
class ComentarioPolicy
{
    ...
    public function store(User $user , Videojuego $videojuego)
    {
        $user->videojuegos()->where('videojuego_id',$videojuego->id)->exists()
            ? Response::allow()
            : Response::deny('No puedes comentar en juegos que no has comprado');
    }
